<?php
/**
 * Template Name: カテゴリニュース表示
 * 
 * Template part for displaying category news on page
 * home-category-news.phpの機能を複製したテンプレートパーツ
 * 固定ページに設定されたpage_categoryタクソノミーに基づいてニュース記事を表示
 *
...
// 固定ページに設定されたpage_categoryタクソノミーのIDを取得
$page_category_terms = get_the_terms($current_page_id, 'page_category');
$page_category_ids = array();

if ($page_category_terms && !is_wp_error($page_category_terms)) {
    foreach ($page_category_terms as $term) {
